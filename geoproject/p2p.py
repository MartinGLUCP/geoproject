"""
Satellite images to maps image translation ​using Pix2Pix GAN
...
from p2p_model import define_discriminator, define_generator, define_gan, train
...
model = load_model('saved_model_5epochs.h5')
